...
import com.opensource.techblog.sampleservice.NoSuchStudentException;
import com.opensource.techblog.sampleservice.model.Student;
import com.opensource.techblog.sampleservice.model.impl.StudentImpl;
import com.opensource.techblog.sampleservice.model.impl.StudentModelImpl;
...
public class StudentPersistenceImpl extends BasePersistenceImpl<Student>
    ...
    protected Student toUnwrappedModel(Student student) {
        ...
        studentImpl.setDob(student.getDob());
        studentImpl.setStandard(student.getStandard());
    ...
    public void afterPropertiesSet() {
        String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
                    com.liferay.util.service.ServiceProps.get(
                        "value.object.listener.com.opensource.techblog.sampleservice.model.Student")));
